...
import FeatureSlider, { SliderFeature } from "../../components/home/FeatureSlider";
...
const HomeScreen = ({ onLoginPress, onNavigateToDashboard }: HomeScreenProps) => {
  ...
  const sliderFeatures: SliderFeature[] = [
    {
      id: 1,
