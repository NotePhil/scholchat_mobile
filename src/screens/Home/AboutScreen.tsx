...
const AboutScreen = ({ onLoginPress }: AboutScreenProps) => {
      ...
      <ScrollView style={styles.container}>
        ...
        >
          ...
          <View style={styles.headerContainer}>
            ...
            <MaterialIcons name="info" size={28} color="#4F46E5" style={styles.titleIcon} />
          </View>
          ...
          >
            <View style={styles.cardHeader}>
              <MaterialIcons name="flag" size={24} color="#4F46E5" style={styles.cardIcon} />
          ...
          >
            <View style={styles.cardHeader}>
              <MaterialIcons name="history" size={24} color="#4F46E5" style={styles.cardIcon} />
          ...
          >
            <View style={styles.cardHeader}>
              <MaterialIcons name="groups" size={24} color="#4F46E5" style={styles.cardIcon} />
          ...
          >
            <View style={styles.cardHeader}>
              <MaterialIcons name="star" size={24} color="#4F46E5" style={styles.cardIcon} />
              <Text style={styles.cardTitle}>Nos Valeurs</Text>
            </View>
            <View style={styles.valuesContainer}>
              <View style={styles.valueItem}>
                <MaterialIcons name="lightbulb" size={20} color="#4F46E5" />
                <Text style={styles.valueText}>Innovation</Text>
              </View>
              <View style={styles.valueItem}>
                <MaterialIcons name="handshake" size={20} color="#4F46E5" />
