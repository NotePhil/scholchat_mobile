...
const DashboardCoursBody = () => {
  ...
  const filteredCours = cours.filter((item) => {
    ...
    const matchesStatus =
      selectedStatus === "tous" || item.etat === selectedStatus;
  ...
  return (
    <View style={coursStyles.container}>
      <ScrollView style={coursStyles.content}>
        ...
        <View style={coursStyles.searchFilterContainer}>
          {/* Search Bar */}
          ...
          {/* Status Dropdown */}
          <TouchableOpacity
            style={coursStyles.statusDropdown}
            onPress={() => setShowStatusDropdown(!showStatusDropdown)}
          >
            <Text style={coursStyles.statusDropdownText}>
        ...
        {showStatusDropdown && (
          <View style={coursStyles.dropdownMenu}>
            {statusOptions.map((option) => (
              <TouchableOpacity
                key={option.value}
                style={coursStyles.dropdownItem}
                onPress={() => {
                  setSelectedStatus(option.value);
                  setShowStatusDropdown(false);
                }}
              >
                <Text style={coursStyles.dropdownItemText}>{option.label}</Text>
            ...
            <View key={coursItem.id} style={coursStyles.coursCard}>
              <View style={coursStyles.coursContent}>
                <View style={coursStyles.coursHeader}>
                  <Text style={coursStyles.coursTitle}>{coursItem.titre}</Text>
                  <View
                    style={[
                ...
                <Text style={coursStyles.coursDate}>
                  Créé le{" "}
                  {new Date(coursItem.dateCreation).toLocaleDateString("fr-FR")}
                </Text>
              </View>
      ...
      <TouchableOpacity
        style={coursStyles.floatingButton}
          ...
          <View style={coursStyles.modalContainer}>
            ...
            {selectedCours && (
              <ScrollView style={coursStyles.modalContent}>
                ...
                <View style={coursStyles.detailRow}>
                  <Text style={coursStyles.detailLabel}>Date de création:</Text>
                  <Text style={coursStyles.detailValue}>
