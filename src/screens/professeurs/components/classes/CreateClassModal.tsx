...
import { ClassEntity, Etablissement, Professor } from "../../../../types";

interface CreateClassModalProps {
  visible: boolean;
  onClose: () => void;
  onCreateClass: (createdClass: ClassEntity) => void;
}

const CreateClassModal = ({ visible, onClose, onCreateClass }: CreateClassModalProps) => {
  const { user } = useUser();
