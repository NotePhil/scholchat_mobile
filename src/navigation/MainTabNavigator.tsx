...
const DashboardStack = ({ onLogout }: DashboardStackProps) => {
  return (
...
interface PublicTabNavigatorProps {
  onLoginPress: () => void;
  onNavigateToDashboard: () => void;
}

// Main Tab Navigator for public screens
const PublicTabNavigator = ({ onLoginPress, onNavigateToDashboard }: PublicTabNavigatorProps) => {
