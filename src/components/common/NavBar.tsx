...
import { View, Image, Text, TouchableOpacity, StyleSheet, Modal, TouchableWithoutFeedback, LayoutChangeEvent } from 'react-native';
...
const NavBar = ({ onLoginPress }: NavBarProps) => {
  ...
  const onLanguageButtonLayout = (event: LayoutChangeEvent) => {
